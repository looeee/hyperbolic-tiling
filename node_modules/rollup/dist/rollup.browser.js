/*
	Rollup.js v0.25.6
	Wed Mar 23 2016 15:22:58 GMT-0700 (PDT) - commit 21b7c7b57dba16871c476a3985cdafd28fdca07f
...
(function (global, factory) {
  ...
  pp$4.toAssignable = function (node, isBinding) {
  ...
  pp$4.toAssignableList = function (exprList, isBinding) {
  ...
  pp$4.parseSpread = function (refDestructuringErrors) {
    var node = this.startNode();
    this.next();
  ...
  pp$4.parseRest = function (allowNonIdent) {
    var node = this.startNode();
    this.next();
  ...
  pp$4.parseBindingAtom = function () {
  ...
  pp$4.parseBindingList = function (close, allowEmpty, allowTrailingComma, allowNonIdent) {
    var elts = [],
        first = true;
  ...
  pp$4.parseBindingListItem = function (param) {
    return param;
  };

  // Parses assignment pattern around given atom if possible.

  pp$4.parseMaybeDefault = function (startPos, startLoc, left) {
  ...
  pp$4.checkLVal = function (expr, isBinding, checkClashes) {
    switch (expr.type) {
      case "Identifier":

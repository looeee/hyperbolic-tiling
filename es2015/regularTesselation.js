...
export class RegularTesselation extends Disk {
  constructor(p, q, rotation, colour, maxLayers, drawClass) {
    super(drawClass);
    this.p = p;
    this.q = q;
    ...
    this.arc(this.fr.a, this.fr.b);
    this.arc(this.fr.a, this.fr.c);
    this.arc(this.fr.b, this.fr.c);
  }
  ...
  fundamentalRegion(){
    ...
    const p1 = E.circleLineIntersect(centre, r, this.centre, b).p1;
